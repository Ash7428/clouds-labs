...
## Ход работы
таблица туть
<img width="1149" height="591" alt="image" src="https://github.com/user-attachments/assets/bffe7435-18f8-45d8-b0d1-eb054c9e2d6e" />
...
## Вывод
В ходе выполнения лабораторной работы я познакомились с облачными сервисами Microsoft Azure, изучила их документацию и классифицировала предоставляемые ими услуги. Была сформирована единую кросс-провайдерную модель, в ходе работы над которой я узнала про ключевые особенности использования каждого сервиса. Результат работы - таблица, которая наглядно демонстрирует классификацию облачных услуг и их назначение.
